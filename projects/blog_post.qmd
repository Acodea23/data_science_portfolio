...
<details>
  <summary>Alternate Image Descriptio</summary>
...
Althogh the dotted line appeared to be an exceptional model for the data collected, it doesn't adequately model the whole population and can't predict future samples.
